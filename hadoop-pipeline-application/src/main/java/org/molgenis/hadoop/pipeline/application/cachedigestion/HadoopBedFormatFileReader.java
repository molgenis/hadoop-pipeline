 ...
 */
public class HadoopBedFormatFileReader extends HadoopFileReader<List<BEDFeature>>
{
	/**
	 * Turns a BED-formatted {@link InputStream} into an {@link List}{@code <}{@link BEDFeature}{@code >}. This
	 ...
	 * 
	 * @return {@link List}{@code <}{@link BEDFeature}{@code >}
	 ...
	 */
	@Override
	public List<BEDFeature> read(InputStream inputStream) throws IOException
	{
		// IMPORTANT:
		...
		final List<BEDFeature> bedFeatures = new ArrayList<BEDFeature>();
	...
	/**
	 * Sorts a given {@link List} with {@link BEDFeature}{@code s} on the {@link BEDFeature#getStart()}, and if the
	 * start value is the same, uses {@link BEDFeature#getEnd()} for sorting as well.
	 * 
	 * @param bedFeatures
	 *            {@link List}{@code <}{@link BEDFeature}{@code >}
	 */
	private void sortBedFeatureArray(List<BEDFeature> bedFeatures)
	{
